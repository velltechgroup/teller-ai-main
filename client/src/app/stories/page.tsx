          ...
          {stories &&
            stories.map((storie: IStory) => (
              <Link
                ...
                className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:border-gray-700 dark:bg-white dark:hover:bg-gray-700">
