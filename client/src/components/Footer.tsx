    ...
    <section className="container mx-auto mt-24 px-8 lg:px-8 relative">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-sm">
          <p className="text-base font-bold tracking-wide text-black mb-4">
            Quick Links
          </p>
          <ul className="flex flex-col gap-4">
            <li>
              <a
                href="/"
                className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple text-black hover:text-primaryColor">
                Home
              </a>
            </li>
            <li>
        ...
        <div>
          <span className="text-base font-bold tracking-wide text-black mb-4">
            Social
          </span>
